...
typedef struct _VHID_VHF_CONTEXT {
    ...
    NTSTATUS LastCommandAcceptStatus;
    NTSTATUS LastCommandReleaseStatus;
    NTSTATUS LastCommandReleaseRetryStatus;
    BOOLEAN LastCommandReleaseRetryAttempted;
    BOOLEAN LastCommandReleaseRetrySucceeded;
    BOOLEAN LastCommandFinalNeutralKnown;
    ULONG LastRejectedCommandType;
    ULONG LastRejectedCommandSequenceId;
    NTSTATUS LastRejectedCommandStatus;

...
The validator checks balanced collections, Report IDs 1, 2, and 3, keyboard,
relative mouse, and absolute mouse top-level usages, mouse button/axis shapes,
and absence of Output or Feature reports. It does not

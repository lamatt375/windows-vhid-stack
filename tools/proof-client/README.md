...
- accepts exactly four verbs: `trigger`, `status`, `move-abs <x> <y>`, and `click-abs <x> <y>`;
...
- does not accept raw HID reports, key codes, text, arbitrary button values, repeat counts, batches, macros, or arbitrary commands;
